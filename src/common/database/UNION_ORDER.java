...
public class UNION_ORDER {
	...
	public UNION_ORDER() {
		...
		map.put("uid", 0);
		map.put("level_1_id", 0);
		map.put("level_1_money", 0.00);
		map.put("level_2_id", 0);
		map.put("level_2_money", 0.00);
		map.put("level_3_id", 0);
		...
		for (String key : data.keySet()) {
			if (map.containsKey(key)) {
				...
				if (key.equals("level_1_id")) {
					if (T.toInt(data.get(key).toString()) > 2147483647) {
						return Common.error("level_1_id最大值2147483647");
					}
					if (data.get(key) == null || data.get(key).toString().trim().equals("")) {
						data.put(key, 0);
					}
				...
				if (key.equals("level_2_id")) {
					if (T.toInt(data.get(key).toString()) > 2147483647) {
						return Common.error("level_2_id最大值2147483647");
					}
					if (data.get(key) == null || data.get(key).toString().trim().equals("")) {
						data.put(key, 0);
					}
				...
				if (key.equals("level_3_id")) {
					if (T.toInt(data.get(key).toString()) > 2147483647) {
						return Common.error("level_3_id最大值2147483647");
					}
					if (data.get(key) == null || data.get(key).toString().trim().equals("")) {
						data.put(key, 0);
					}
