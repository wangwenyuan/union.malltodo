...
public class RENOVATION {
	...
	public static String background_repeat = "background_repeat";
	public static String type = "type";
	public static String platform = "platform";
	public static String html = "html";
	public static String doms = "doms";
	public static String doms_sort = "doms_sort";
	public static String header_id = "header_id";
...
if (data.get(key).toString().length() > 255) {
return Common.error("background_image最长255个字符");
}
}
if (key.equals("background_repeat")) {
if (data.get(key).toString().length() > 25) {
return Common.error("background_repeat最长25个字符");
}
}
if (key.equals("type")) {
if (data.get(key).toString().length() > 25) {
...
if (data.get(key).toString().length() > 25) {
return Common.error("平台类型：pc或者mobile最长25个字符");
}
}
if (key.equals("html")) {
...
if (data.get(key).toString().length() > 25) {
return Common.error("header_id最长25个字符");
}
}
if (key.equals("bottom_id")) {
if (data.get(key).toString().length() > 25) {
return Common.error("底部菜单id最长25个字符");
}
}
