...
public class UnionBaseGoodsModel {
	...
	public JSONObject getValue(JSONObject selfParameter, JSONObject webRequestParam, HttpServletRequest request) throws SQLException, UnsupportedEncodingException {
		...
		JSONArray goods_list = Functions.getGoodsList(Common.unionHost + "/api.jsp?m=Index&c=GoodsList&a=index" + param, uid, request);
		if (goods_list == null) {
			return null;
		} else {
