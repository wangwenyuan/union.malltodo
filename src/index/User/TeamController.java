...
public class TeamController extends UserCommonController {
	...
	public void teamListPage() throws SQLException, UnsupportedEncodingException {
		Map<String, W> where = new HashMap<String, W>();
		where.put(RENOVATION.type, new W("eq", "User/Team/index"));
		where.put(RENOVATION.is_default, new W("eq", 1));
		where.put(RENOVATION.is_del, new W("eq", 0));
