...
public class MoneyLogController extends UserCommonController {
	public void indexPage() throws SQLException, UnsupportedEncodingException {
		Map<String, W> where = new HashMap<String, W>();
		where.put(RENOVATION.type, new W("eq", "User/MoneyLog/index"));
	...
	public void moneyLogListPage() throws SQLException, UnsupportedEncodingException {
		Map<String, W> where = new HashMap<String, W>();
		where.put(RENOVATION.type, new W("eq", "User/MoneyLog/index"));
		where.put(RENOVATION.is_default, new W("eq", 1));
		where.put(RENOVATION.is_del, new W("eq", 0));
