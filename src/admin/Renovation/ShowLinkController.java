...
public class ShowLinkController extends CommonController {

	public void indexPage() throws IOException, ServletException, TemplateException {
		Map<String, String> linkMap = new LinkedHashMap();
		linkMap.put("首页", T.U("Index/Index/index", "index.jsp"));
		linkMap.put("商品栏目", T.U("Index/Index/menu", "index.jsp"));
		linkMap.put("会员中心", T.U("User/Index/index", "index.jsp"));
		linkMap.put("我的订单", T.U("User/Order/index", "index.jsp"));
		linkMap.put("推广海报", T.U("Index/Qr/index", "index.jsp"));
		linkMap.put("我的团队", T.U("User/Team/index", "index.jsp"));
		linkMap.put("我的收益", T.U("User/Income/index", "index.jsp"));
		linkMap.put("资金记录", T.U("User/MoneyLog/index", "index.jsp"));
		linkMap.put("我要提现", T.U("User/Withdrawal/index", "index.jsp"));
		linkMap.put("基本信息设置", T.U("User/Set/index", "index.jsp"));
