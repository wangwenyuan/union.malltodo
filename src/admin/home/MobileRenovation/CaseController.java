...
public class CaseController extends BaseRenovation {
	public Boolean init() {
		Boolean b = super.init();
		if (b) {
			this.type = "Index/Case/index";
			this.platform = "mobile";
			this.assign("page_action", "应用案例栏目");
			return true;
		} else {
			return false;
		}
	...
	public static JSONObject getBusinessListDom(String root, String rootUrl, JSONObject doms) throws IOException {
