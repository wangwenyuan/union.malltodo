...
public class ContactUsController extends BaseRenovation {
	public Boolean init() {
	...
	public static JSONObject getContactUsListDom(String root, String rootUrl, JSONObject doms) throws IOException {
