...
public class AlbumController extends BaseRenovation {
	public Boolean init() {
	...
	public static JSONObject getAlbumListDom(String root, String rootUrl, JSONObject doms) throws IOException {
