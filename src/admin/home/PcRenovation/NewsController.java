...
public class NewsController extends BaseRenovation {
	public Boolean init() {
	...
	public static JSONObject getNewsListDom(String root, String rootUrl, JSONObject doms) throws IOException {
