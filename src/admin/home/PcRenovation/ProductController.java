...
public class ProductController extends BaseRenovation {
	public Boolean init() {
	...
	public static JSONObject getProductListDom(String root, String rootUrl, JSONObject doms) throws IOException {
		JSONObject object = new JSONObject();
		JSONArray doms_sort = new JSONArray();
		for (String key : doms.keySet()) {
			if (doms.getJSONObject(key).getString("category").equals("home_index_products_list_pc")) {
