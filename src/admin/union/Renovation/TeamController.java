...
public class TeamController extends BaseRenovation {
	public Boolean init() {
		Boolean b = super.init();
		if (b) {
			this.type = "User/Team/index";
			this.platform = "mobile";
			this.assign("page_action", "我的团队");
			return true;
		} else {
			return false;
		}
	...
	public static JSONObject getTeamListDom(String root, String rootUrl, JSONObject doms) throws IOException {
		JSONObject object = new JSONObject();
		JSONArray doms_sort = new JSONArray();
		for (String key : doms.keySet()) {
			if (doms.getJSONObject(key).getString("category").equals("union_teamList_mobile")) {
