...
public class SearchController extends BaseRenovation {
	public Boolean init() {
		Boolean b = super.init();
		if (b) {
			this.type = "Union/Index/search";
			this.platform = "mobile";
			this.assign("page_action", "搜索页面");
			return true;
		} else {
			return false;
		}
	...
	public static JSONObject getGoodsListDom(String root, String rootUrl, JSONObject doms) throws IOException {
		...
		for (String key : doms.keySet()) {
			if (doms.getJSONObject(key).getString("category").equals("union_searchGoodsList_mobile")) {
