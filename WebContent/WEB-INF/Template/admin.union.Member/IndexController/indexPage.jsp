            ...
            <div class="clear_5px"></div>
              <table width="100%" cellpadding="0" cellspacing="0" class="main_table">
                ...
                for(Integer i=0; i<list.size(); i=i+1){
                	...
                	out.println("<td><a href=\"javascript:shop.sub_window('调整余额', '"+T.U("Member/Index/balance", "id="+jsonObject.getString("id"), "admin.union.jsp", request)+"')\">调整余额</a></td>");
                	out.println("<td><a href=\"javascript:shop.del('"+T.U("Member/Index/del", "admin.union.jsp", request)+"','"+jsonObject.getString("id")+"')\">删除</a></td>");
                	out.println("</tr>");
                }
                %>
                </table>
