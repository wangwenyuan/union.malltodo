...
$('.zuo_li').click(function(){
	...
	$(this).css({'background':'url(Public/admin/images/arrow.png)','color':'#333'});
...
$('.<%=bottom_input.get("m")%>_<%=bottom_input.get("c")%>').css({'background':'url(<%=request.getAttribute("PUBLIC") %>/admin/images/arrow.png)','color':'rgb(51,51,51)'}).addClass('zuo_li_dianji');
