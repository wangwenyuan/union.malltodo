...
<div class="menu_box" onclick="show_widgets_window('栏目名称组件', '<%=T.U("Renovation/ShowWidget/index", "category=categoryName", "admin.jsp") %>')">栏目名称组件</div>
<div class="menu_box" onclick="show_widgets_window('商品列表', '<%=T.U("Renovation/ShowWidget/index", "category=categoryGoodsList", "admin.jsp") %>')">商品列表</div>
