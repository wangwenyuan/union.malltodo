...
<div class="menu_box" onclick="show_widgets_window('我的收益列表', '<%=T.U("Renovation/ShowWidget/index", "category=union_incomeList_mobile", "admin.union.jsp", request) %>')">我的收益列表</div>
