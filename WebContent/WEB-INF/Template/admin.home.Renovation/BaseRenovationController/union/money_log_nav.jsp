...
<div class="menu_box" onclick="show_widgets_window('资金记录列表', '<%=T.U("Renovation/ShowWidget/index", "category=union_moneyLogList_mobile", "admin.union.jsp", request) %>')">资金记录列表</div>
