...
<div class="menu_box" onclick="show_widgets_window('商品列表', '<%=T.U("Renovation/ShowWidget/index", "category=union_searchGoodsList_mobile", "admin.union.jsp", request) %>')">商品列表</div>
