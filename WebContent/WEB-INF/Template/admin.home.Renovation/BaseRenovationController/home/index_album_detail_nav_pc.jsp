...
<div class="menu_box" onclick="show_widgets_window('公司相册组件', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_album_detail_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">公司相册组件</div>
