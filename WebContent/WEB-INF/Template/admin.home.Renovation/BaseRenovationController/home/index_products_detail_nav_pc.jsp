...
<div class="menu_box" onclick="show_widgets_window('产品详情组件', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_products_detail_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">产品详情组件</div>
