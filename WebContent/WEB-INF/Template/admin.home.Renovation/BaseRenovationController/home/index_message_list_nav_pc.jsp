...
<!-- <div class="menu_box" onclick="show_widgets_window('客户留言组件', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_message_list_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">客户留言组件</div> -->
