...
<div class="menu_box" onclick="show_widgets_window('订单列表', '<%=T.U("Renovation/ShowWidget/index", "category=orderList", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">订单列表</div>
