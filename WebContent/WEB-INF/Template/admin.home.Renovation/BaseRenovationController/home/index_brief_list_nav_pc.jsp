...
<div class="menu_box" onclick="show_widgets_window('公司简介列表', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_brief_list_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">公司简介列表</div>
<div class="menu_box" onclick="show_widgets_window('公司简介单页', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_brief_page_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">公司简介单页</div>
