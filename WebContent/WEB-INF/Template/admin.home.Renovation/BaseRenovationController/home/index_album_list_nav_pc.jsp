...
<div class="menu_box" onclick="show_widgets_window('公司相册列表', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_album_list_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">公司相册列表</div>
<div class="menu_box" onclick="show_widgets_window('公司相册单页', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_album_page_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">公司相册单页</div>
