...
<div class="menu_box" onclick="show_widgets_window('团队成员列表', '<%=T.U("Renovation/ShowWidget/index", "category=teamList", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">团队成员列表</div>
