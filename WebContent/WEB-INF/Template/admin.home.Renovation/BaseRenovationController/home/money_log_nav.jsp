...
<div class="menu_box" onclick="show_widgets_window('资金记录列表', '<%=T.U("Renovation/ShowWidget/index", "category=moneyLogList", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">资金记录列表</div>
