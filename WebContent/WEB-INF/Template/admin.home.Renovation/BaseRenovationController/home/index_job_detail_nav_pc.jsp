...
<div class="menu_box" onclick="show_widgets_window('人力招聘组件', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_job_detail_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">人力招聘组件</div>
