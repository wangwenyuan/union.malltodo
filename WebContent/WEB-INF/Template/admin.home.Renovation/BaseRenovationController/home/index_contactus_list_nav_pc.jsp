...
<div class="menu_box" onclick="show_widgets_window('联系我们列表', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_contactus_list_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">联系我们列表</div>
<div class="menu_box" onclick="show_widgets_window('联系我们单页', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_contactus_page_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">联系我们单页</div>
