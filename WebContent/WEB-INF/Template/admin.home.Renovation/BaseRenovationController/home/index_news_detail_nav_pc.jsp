...
<div class="menu_box" onclick="show_widgets_window('新闻详情组件', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_news_detail_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">新闻详情组件</div>
