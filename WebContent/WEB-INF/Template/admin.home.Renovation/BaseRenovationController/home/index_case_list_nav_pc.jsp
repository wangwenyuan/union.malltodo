...
<div class="menu_box" onclick="show_widgets_window('应用案例列表', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_case_list_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">应用案例列表</div>
<div class="menu_box" onclick="show_widgets_window('应用案例单页', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_case_page_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">应用案例单页</div>
