...
<div class="menu_box" onclick="show_widgets_window('面包导航', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_bread_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">面包导航</div>
