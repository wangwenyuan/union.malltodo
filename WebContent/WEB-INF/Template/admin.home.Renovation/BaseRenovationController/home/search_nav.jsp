...
<div class="menu_box" onclick="show_widgets_window('商品列表', '<%=T.U("Renovation/ShowWidget/index", "category=searchGoodsList", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">商品列表</div>
