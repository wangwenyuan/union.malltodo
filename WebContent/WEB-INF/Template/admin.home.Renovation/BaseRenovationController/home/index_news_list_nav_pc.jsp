...
<div class="menu_box" onclick="show_widgets_window('新闻列表组件', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_news_list_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">新闻列表</div>
<div class="menu_box" onclick="show_widgets_window('新闻列表组件', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_news_page_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">新闻单页</div>
