...
<div class="menu_box" onclick="show_widgets_window('产品列表组件', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_products_list_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">产品列表</div>
<div class="menu_box" onclick="show_widgets_window('产品列表组件', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_products_page_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">产品单页</div>
