...
<div class="menu_box" onclick="show_widgets_window('业务范围列表', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_business_list_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">业务范围列表</div>
<div class="menu_box" onclick="show_widgets_window('业务范围单页', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_business_page_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">业务范围单页</div>
