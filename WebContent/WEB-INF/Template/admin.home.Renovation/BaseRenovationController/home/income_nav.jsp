...
<div class="menu_box" onclick="show_widgets_window('我的收益列表', '<%=T.U("Renovation/ShowWidget/index", "category=incomeList", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">我的收益列表</div>
