...
<div class="menu_box" onclick="show_widgets_window('公司简介组件', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_brief_detail_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">公司简介组件</div>
