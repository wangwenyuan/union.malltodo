...
<div class="menu_box" onclick="show_widgets_window('业务范围组件', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_business_detail_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">业务范围组件</div>
