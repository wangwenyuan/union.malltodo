...
<div class="menu_box" onclick="show_widgets_window('人力招聘列表', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_job_list_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">人力招聘列表</div>
<div class="menu_box" onclick="show_widgets_window('人力招聘单页', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_job_page_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">人力招聘单页</div>
