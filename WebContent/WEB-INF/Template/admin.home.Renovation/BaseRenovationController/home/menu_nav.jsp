...
<div class="menu_box" onclick="show_widgets_window('栏目组件', '<%=T.U("Renovation/ShowWidget/index", "category=menu", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">类目体</div>
