...
<div class="menu_box" onclick="show_widgets_window('应用案例组件', '<%=T.U(request.getAttribute("MODULE_NAME").toString()+"/ShowWidget/index", "category=home_index_case_detail_pc", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">应用案例组件</div>
