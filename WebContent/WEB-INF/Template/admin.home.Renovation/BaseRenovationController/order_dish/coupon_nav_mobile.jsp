...
<div class="menu_box" onclick="show_widgets_window('优惠券列表', '<%=T.U("OrderDish/ShowWidget/index", "category=order_dish_coupon_mobile", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">优惠券列表</div>
