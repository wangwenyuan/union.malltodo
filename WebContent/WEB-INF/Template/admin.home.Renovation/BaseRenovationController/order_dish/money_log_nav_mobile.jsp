...
<div class="menu_box" onclick="show_widgets_window('资金记录', '<%=T.U("OrderDish/ShowWidget/index", "category=order_dish_money_log_mobile", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">资金记录组件</div>
