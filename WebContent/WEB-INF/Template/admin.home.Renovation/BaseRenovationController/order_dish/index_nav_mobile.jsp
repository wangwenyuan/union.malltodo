...
<div class="menu_box" onclick="show_widgets_window('菜品组件', '<%=T.U("OrderDish/ShowWidget/index", "category=order_dish_food_mobile", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">菜品组件</div>
