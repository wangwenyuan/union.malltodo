...
<div class="menu_box" onclick="show_widgets_window('订单列表', '<%=T.U("OrderDish/ShowWidget/index", "category=order_dish_order_mobile", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">订单列表</div>
