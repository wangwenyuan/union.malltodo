...
<div class="menu_box" onclick="show_widgets_window('会员组件', '<%=T.U("OrderDish/ShowWidget/index", "category=order_dish_user_mobile", "admin."+Functions.getMenuCategoryName(request)+".jsp", request) %>')">会员组件</div>
