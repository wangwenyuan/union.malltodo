...
<div style="padding:1rem">
	<div style="font-size:0.875rem; line-height:35px;">
		<div>手机号：<%=user.getString(MEMBER.mobile) %> <span style="float:right"><a style="color:#333333; text-decoration:underline" href="<%=T.U("User/Set/tel", "index.jsp") %>">修改</a></span></div>
		<div>登录密码：****** <span style="float:right"><a style="color:#333333; text-decoration:underline" href="<%=T.U("User/Set/password", "index.jsp") %>">修改</a></span></div>
		<div>昵称：<%=user.getString(MEMBER.username) %> <span style="float:right"><a style="color:#333333; text-decoration:underline" href="<%=T.U("User/Set/username", "index.jsp") %>">修改</a></span></div>
	</div>
</div>
