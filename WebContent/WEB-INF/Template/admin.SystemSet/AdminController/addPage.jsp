...
<form method="post" action="" id="html_form">
    <table width="100%" cellpadding="0" cellspacing="0" class="small_main_table">
        ...
        <tr><td align="right" width="150px">所属岗位：</td><td align="left"><%=Common.template.htmlWidget("select_widget", ADMIN.group_id, T.getString(ADMIN.group_id, info), JSON.toJSONString(map)) %></td></tr>
