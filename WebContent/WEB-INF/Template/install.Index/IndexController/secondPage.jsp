...
<div id="login">
    ...
    <div class="install_btn">
        <div id="tijiao" style="float:left" onclick="window.location.href = '<%=T.U("Index/Index/index", "index.jsp") %>'">
            上一步
        </div>
        <div id="tijiao" style="float:right" onclick="window.location.href = '<%=T.U("Index/Index/third", "index.jsp") %>'">
            下一步
        </div>
