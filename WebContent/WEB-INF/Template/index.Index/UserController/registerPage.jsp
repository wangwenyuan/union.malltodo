...
<html>
	...
	<body style="background:#FFF;">
		...
		<div class="input_box zhuce"><span style="float: left;"><a href="<%=T.U("Index/User/login", "index.jsp") %>">登录</a></span><span style="float: right;"><a href="<%=T.U("Index/User/find_password", "index.jsp") %>">找回密码</a></span></div>
		...
		<script>
			...
			send_sms("<%=T.U("Index/User/send_register_sms", "index.jsp") %>");
			...
			function register(){
				...
				http.post("<%=T.U("Index/User/register", "index.jsp") %>", shuju, function(data){
					layer.msg(data["info"], {
					    time: 2000
					}, function () {
					    if (data["url"] != "") {
			...
			function show_agreement(){
				layer.open({
					...
					maxmin: true,
					area: ['70%', '70%'],
					content: ["<%=T.U("Index/User/agreement", "index.jsp") %>"],
				});
			}
		</script>
	</body>
