...
<html>
	...
	<body style="background:#FFF;">
		...
		<div class="input_box zhuce"><span style="float: left;"><a href="<%=T.U("Index/User/login", "index.jsp", request) %>">登录</a></span><span style="float: right;"><a href="<%=T.U("Index/User/register", "index.jsp", request) %>">注册</a></span></div>
		...
		<script>
			...
			send_sms("<%=T.U("Index/User/send_find_password_sms", "index.jsp", request) %>");
			...
			function find_password(){
				...
				http.post("<%=T.U("Index/User/find_password", "index.jsp", request) %>", shuju, function(data){
					layer.msg(data["info"], {
					    time: 2000
					}, function () {
					    if (data["url"] != "") {
