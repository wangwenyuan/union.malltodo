...
<html>
	...
	<body style="background:#FFF;">
		...
		<div class="input_box zhuce"><span style="float: left;"><a href="<%=T.U("Index/User/register", "index.jsp", request) %>">注册</a></span><span style="float: right;"><a href="<%=T.U("Index/User/find_password", "index.jsp", request) %>">找回密码</a></span></div>
		<style>
			#zhegai {
				background: #000;
				position: fixed;
