...
<%@include file="header.jsp"%>
	...
	<div style="font-size:14px;">
	    ...
	    <p>感谢您选择MALLTODO零代码企业建站系统（以下简称MALLTODO），MALLTODO由郑州掌勺信息技术有限公司开发，是目前国内强大、稳定的企业网站建设解决方案之一，基于 JAVA + MySQL 的技术开发，源码开放。</p>
	    <p>MALLTODO 的官方网址是： www.malltodo.com</p>
	    <p><strong>MALLTODO协议条款</strong></p>
	    <p>为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：</p>
	    <p>一、本授权协议适用且仅适用于 MALLTODO V1.x 版本，MALLTODO官方对本授权协议的最终解释权。</p>
	    <p>二、协议许可的权利</p>
	    ...
	    <p>协议发布时间： 2021年09月01日</p>
	    <p>版本最新更新： 2021年09月01日 By malltodo.com</p>
	</div>
